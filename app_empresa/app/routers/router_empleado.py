...
def formEmpleado():
    if 'conectado' in session:
        if 'foto_perfil' in request.files:
            ...
            resultado = procesar_from_empleado(request.form, foto_perfil)
            if resultado:
...
def detalleEmpleado(idEmpleado=None):
    if 'conectado' in session:
        # Verificamos si el parametro idEmpleado es None o no está presente en la URL
...
# Recibir formulario para actualizar informacion de empleado
